...
from training.train_pub import create_callbacks_model_file, train_r_net_with_data_generator
...
def train_with_data_generator(dataset_root_dir = GAN_DATA_ROOT_DIR, weights_file=None):
    ...
    data_generator = DataGenerator(pos_dataset_path, neg_dataset_path, part_dataset_path, batch_size,
